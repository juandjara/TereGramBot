...
const commandDoc = [
  {command: '/help', description: 'Lista de comandos disponibles (esta lista)', shortDescription: 'Lista de comandos'},
  {command: '/echo', description: 'Recibe un texto y lo repite', shortDescription: 'Repite un mensaje'},
  {
  ...
  {command: '/cat', description: 'Fotos de gatos, el nucleo de internet', shortDescription: 'Gatitos'},
  {command: '/dog', description: 'Fotos de perros, porque no discriminamos', shortDescription: 'Perretes'},
  {command: '/yesno', description: 'Por si no sabes si debieras hacer algo', shortDescription: '¿Sí o no, Tere?'},
  {
    command: '/repo',
    description: 'Enlace al repositorio de GitHub de este bot',
    shortDescription: 'Enlace al repositorio'
  },
  {command: '/status', description: 'Comprueba el estado de Tere', shortDescription: 'Tere, ¿estás viva?'},
  {
    command: '/donger',
  ...
  {command: '/flame', description: 'illo callarse', shortDescription: 'Illo callarse'},},
  {command: '/hiddenmsg', description: 'Uy, esto no se para qué es...', shortDescription: 'Repite disimulá'},
];
